...
DISCLAIMER_SHORT = ("본 사이트는 KRX 공개 정보를 가공한 <b>시장 현황 요약</b>이며, "
...
<div class="copy">© 2026 {SITE_NAME}. 데이터 출처: KRX 공개 정보. 문의: {CONTACT_EMAIL}</div>
</div></footer>
<script>
(function(){{
...
<h2>데이터는유</h2>
<p>모든 수치는 KRX 공개 시세로 계산한 <b>과거·당일 사실 데이터</b>유.
...
<h2>어떻게 계산하냐면유</h2>
<p>매 거래일 장 마감 뒤, KRX 공개 시세를 테마별로 묶어 이렇게 집계해유:</p>
<div class="card">
...
<h3>데이터 출처가 어디예유?</h3>
<p>전부 한국거래소(KRX) 공개 시세유. 그 시세를 테마별로 묶어 평균 등락률·5%↑ 종목 수·오른
...
정보는 KRX 공개 데이터를 가공한 <b>시장 현황 요약(정보 제공)</b>이며, 특정 종목·시점에 대한
매수·매도·보유 권유가 아닙니다.</p>
</div>
...
<h2>데이터 출처</h2>
<p>한국거래소(KRX) 및 공개된 시세 정보를 기반으로 합니다. 원천 데이터의 권리는 각 제공처에 있습니다.</p>

<p class="updated">최종 개정: 2026-06-13</p>
</div></main>
"""
...
이용자는 <a href="https://www.google.com/settings/ads" rel="noopener" target="_blank">Google 광고 설정</a>에서
...
<h2>제2조 (서비스의 성격)</h2>
<p>사이트는 KRX 공개 데이터를 가공한 시장 현황 정보를 무료로 제공합니다. 사이트는 투자자문·
