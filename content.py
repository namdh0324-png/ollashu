...
SITE_DESC = "코스피·코스닥·NXT에서 오늘 오른 테마주를 공개 시세로 한눈에 보여주는 히트맵입니다. 종목 추천 없이 시장 현황만 정리합니다."
...
.hero-intro{margin:0 0 14px; color:var(--text-mid); font-size:16px; line-height:1.6; max-width:64ch}
